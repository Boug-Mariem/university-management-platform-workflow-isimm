...
const DemandeRecuSimple = () => {
  ...
  const allerDetailAttestation=(id) =>{
    navigate('/MenuAdmin/DetailAttestation',{ state: { iddemandeAttes: id } });
  }
  const allerDetailConge=(id) =>{
    navigate('/MenuAdmin/DetailDemandeConge',{ state: { iddemande: id } });
  }
  return (
    <motion.div
...
export default DemandeRecuSimple;
