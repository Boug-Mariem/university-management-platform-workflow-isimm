...
const AdminProfileSimple = () => {
  ...
  const allerChangePassword=(pers) =>{
    navigate('/MenuAdmin/ChangePassword',{ state: { adminU: pers } });
  }
//min-h-screen max-h-screen element-scroll bg-white p-8 rounded-lg shadow-lg
  return (
    <motion.div
...
export default AdminProfileSimple;